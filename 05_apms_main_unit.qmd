...
![**Figure 32.2. **Pratley putty strain relief for USB socket.](images/media/32_2_pratley_socket.jpeg){width="600" fig-align="center"}
...
![**Figure 33.** APMS Main Unit frontside.](images/media/33_apms_front.jpeg){width="600" fig-align="center"}
...
- General Measure GMT-X1
    - The GMT-X1 uses a 7-pin screw connector for communication between the loadcell and the indicator, a 2-pin screw connector for 24V power supply, and a 6-pin screw connector for communication (RX/TX) between the Raspberry Pi and the indicator (Fig. 41.1)
    
![**Figure 41.1.** GMT-X1 scale indicator power and loadcell connectors.](images/media/41_1_connectors.jpg){width="600" fig-align="center"}
![**Figure 41.2.** GMT-X1 scale indicator RX/TX Raspberry Pi connectors.](images/media/41_2_connectors.jpg){width="600" fig-align="center"}


- Laumas TLB485
    -   The Laumas TLB485 scale indicator uses an 8-pin screw connector for power and serial communication. The connector, as well as the layout of the two RS485 Serial Converters (Fig. 41.2).


-   Shorten the cables of the RS485 converters to fit the layout shown.

![**Figure 41.3.** Laumas TLB485 scale indicator connectors.](images/media/41_connectors.png){width="700" fig-align="center"}
...
![**Figure 42.2.** Laumas TLB485 USB to RS485 wiring.](images/media/42_usb_rs485.png){width="600" fig-align="center"}
...
![**Figure 43.2.** Laumas TLB485 load cell wiring.](images/media/43_loadcell_wiring.png){width="600" fig-align="center"}
...
![**Figure 44.2.** Installing 6-pin scale connector.](images/media/44_6-pin_connector.png){width="600" fig-align="center"}
...
To configure the GMT-X1 scale indicator, press the enter (**ENT**) button to open the menu, then press the right arrow to navigate to **4xxx Data-Trans**. Then use the down arrow to go to **43xx COM2** and press enter again. Next, select the parameters in the table below and set it to the correct value.
  
![**Figure 45.** General Measure GMT-X1 indicator serial port parameter menu for COM2.](images/media/46_0_GMTX1_COM2.jpeg){width="600" fig-align="center"} 

| **Parameter**    | **Value** | **Image**                                      |
|------------------|-----------|------------------------------------------------|
| **432x Baudrate**| 115200    | ![](images/media/45_432x.jpg){width="200"}     |
| **433x Protocol**| Cont-A    | ![](images/media/45_433x.jpg){width="200"}     |
| **434x Data Format** | 8-N-1 | ![](images/media/45_434x.jpg){width="200"}     |
| **436x Send Gap**| 0009 ms   | ![](images/media/45_436x.jpg){width="200"}     |
...
![**Figure 47.** Monitor board mounted inside the APMS Main Unit.](images/media/46_monitor.png){width="600" fig-align="center"}